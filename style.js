...
(function (blink) {
	...
	var nuevodiverso_demoStyle = function () {
			blink.theme.styles.basic.apply(this, arguments);
		},
		page = blink.currentPage;

	nuevodiverso_demoStyle.prototype = {
		bodyClassName: 'content_type_clase_nuevodiverso_demo',
		ckEditorStyles: {
			name: 'nuevodiverso_demo',
			styles: [
		...
		formatCarouselindicators: function () {
			...
			$navbarBottom
				.attr('class', 'nuevodiverso_demo-navbar')
		...
		animateNavbarOnScroll: function () {
			...
			var $navbar = $('.nuevodiverso_demo-navbar');
			var lastScrollTop = 0;
        ...
        changeHighBar: function () {
            if($('.nuevodiverso_demo-navbar').length>0 && $('.navbar').length>0){
                blink.theme.setTopByHeight('.navbar', '.nuevodiverso_demo-navbar');
            }
        }
	};

	nuevodiverso_demoStyle.prototype = _.extend({}, new blink.theme.styles.basic(), nuevodiverso_demoStyle.prototype);

	blink.theme.styles['nuevodiverso_demo'] = nuevodiverso_demoStyle;
